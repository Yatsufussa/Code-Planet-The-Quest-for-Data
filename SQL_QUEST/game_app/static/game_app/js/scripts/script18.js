...
document.getElementById("submit-query").addEventListener("click", function() {
    ...
    var correctQuery = "SELECT CONCAT( a.StorageName, b.StorageStatus) AS CombinedValue FROM CodeCodeksRidge a, CodeCodeksRidge b WHERE a.StorageName= 'UNI' AND b.StorageStatus= 'ON';";
