const dialogue = [
    "Scene: Nick descends into the depths of the planet, where the source of the virus lies. Here, he faces the most dangerous trials.",
    "Nick: This place looks dangerous...",
    "Nick encounters difficulties and dangers until he reaches the source of the virus",
    "Riddle: To combine data from different tables in SQL, a specific function is often used. What function is it?"
];
