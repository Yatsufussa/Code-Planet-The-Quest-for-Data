const dialogue = [
    "Scene: Nick enters the realm of computing clouds, where the virus utilizes the power of the cloud for its purposes. He must fight the virus at its source.",
    "Nick: This is a computing cloud...",
    "Nick battles the virus, which uses cloud computing for its purposes",
    "Riddle: To calculate the average value in a column in SQL, a specific function is often used. What function is it?"
];
