const dialogue = [
    "Scene: Nick reaches the place where codes and instructions related to the virus are stored. He must find a way to decode them.",
    "Nick: Here are the virus codes...",
    "Nick analyzes the codes to find vulnerabilities",
    "Riddle: To combine the results of multiple queries in SQL, a specific operator is used. What operator is it?"
];
